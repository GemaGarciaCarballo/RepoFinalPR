	...
	public void menuPrincipal() {
		...
		do {
			...
			case 1: 
				...
				break;
			case 2:
				GestionPuntos.leerRanking();
				GestionPuntos.mostrarRanking();
				break;
			case 3:
				GestionPuntos.leerHistorico();
				GestionPuntos.mostrarHistorico();
				break;
			case 4:
				menuJugadores();
				break;
...
//				gestionUsuario.eliminarJugador(jugador);
			...
			for (int i = 0; i < orden.size(); i++) {
				...
				if (orden.get(i) instanceof CPU) {
					...
					case 1:
						...
						String respuestaRealM = String.valueOf(PreguntaMates.guardarRespuestaCorrecta(preguntaM));
					...
					case 2:
						...
						ArrayList <String> respuestaRealL = new ArrayList<String>();
						respuestaRealL = PreguntaLengua.guardarRespuestaCorrecta(preguntaL, posicionesAleatorias);
	...
	public void menuFinPartida() {
		Scanner leer = new Scanner(System.in);
		GestionPuntos.escribirHistorico();
		GestionPuntos.escribirRanking();
